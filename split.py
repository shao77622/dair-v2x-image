...
orin_img_path='/Users/shaoben/Documents/dataset/DAIR-V2X/DAIR-V2X-I/single-infrastructure-side-image'
orin_img_dir=os.listdir(orin_img_path)
orin_lb_path='/Users/shaoben/Documents/dataset/DAIR-V2X/DAIR-V2X-I/single-infrastructure-side-label/label_yolo'
orin_lb_dir=os.listdir(orin_lb_path)
##train
train_img_path = "/Users/shaoben/Documents/dataset/DAIR-V2X/DAIR-V2X-I/train_dair_v2x/images"
train_img_dir = os.listdir(train_img_path)  # image
train_lb_path="/Users/shaoben/Documents/dataset/DAIR-V2X/DAIR-V2X-I/train_dair_v2x/labels"
train_lb_dir = os.listdir(train_lb_path)

##val
val_img_path = "/Users/shaoben/Documents/dataset/DAIR-V2X/DAIR-V2X-I/val_dair_v2x/images"
val_img_dir = os.listdir(val_img_path)  # image
val_lb_path="/Users/shaoben/Documents/dataset/DAIR-V2X/DAIR-V2X-I/val_dair_v2x/labels"
